...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.ingameGUI = new RenderHook(this);

        // calling the pre initialization of the base
        Lite.initialize();

        // calling the pre init event so managers can be setup
        Lite.EVENT_BUS.call(new InitializeEvent());
    ...
    public void shutdownMinecraftApplet() {
        // make sure that the client has shutdown correctly
        Lite.shutdown();
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    default:
                        ...
                        if (this.playerController.isNotCreative()) {
                            ...
                            if (Animations.oldAnimations && Lite.MODULE_FACTORY.findByClass(Animations.class).getData().isEnabled()) {
    ...
    public void runTick() throws IOException {
        Lite.EVENT_BUS.call(new TickEvent());
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        // calling the keyboard key press event
                        KeyboardInputEvent keyboardInputEvent = new KeyboardInputEvent(k);

                        Lite.EVENT_BUS.call(keyboardInputEvent);
