...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            Lite.EVENT_BUS.call(new RenderEntityEvent(p_77036_2_, p_77036_3_, p_77036_4_, entitylivingbaseIn, false).setType(Event.Type.PRE));

            this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);

            Lite.EVENT_BUS.call(new RenderEntityEvent(p_77036_2_, p_77036_3_, p_77036_4_, entitylivingbaseIn, false).setType(Event.Type.POST));
    ...
    {
        Lite.EVENT_BUS.call(new RenderEntityEvent(p_177093_2_, p_177093_3_, p_177093_5_, entitylivingbaseIn, true).setType(Event.Type.PRE));
        ...
        Lite.EVENT_BUS.call(new RenderEntityEvent(p_177093_2_, p_177093_3_, p_177093_5_, entitylivingbaseIn, true).setType(Event.Type.POST));
    }
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)})) {
            if (!Lite.EVENT_BUS.<Event>call(new RenderNameTagEvent(entity,
                    entity.getDisplayName().getFormattedText(), x, y, z, 10)).isCancelled()) {
