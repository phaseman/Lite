...
public class ItemRenderer
{
    ...
    private void func_178105_d(float p_178105_1_)
    {
        ...
        float f = (animations.smoothSwing
                && swingType == Animations.SwingType.SMOOTH ? -0.05F : -0.4F) * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * (float)Math.PI);
        float f1 = 0.2F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * (float)Math.PI * 2.0F);
        float f2 = (animations.smoothSwing
                && swingType == Animations.SwingType.SMOOTH ? -0.2F : -0.2F) * MathHelper.sin(p_178105_1_ * (float)Math.PI);
        GlStateManager.translate(f, f1, f2);
    }
                            ...
                            switch (animations.getCurrentMode().getName()) {
                                ...
                                case "Exhibition": {
                                    if (itemToRender.getItem() instanceof ItemSword) {
                                        ...
                                        this.transformFirstPersonItem(!animations.equipReset ? 0 : (f / 3), 0.0f);
                                ...
                                case "Dev": {
                                    if (itemToRender.getItem() instanceof ItemSword) {
                                        float f6 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * Math.PI));
                                        GL11.glTranslated(0.1D, 0.1D, 0.0D);
                                        this.transformFirstPersonItem(!animations.equipReset ? 0 : (float) (f / Math.PI), 0.0f);
                                        GlStateManager.rotate(f6 * 20, f6 / 2.0F, -0.0F, 9.0F);
                                        this.func_178103_d();
                                    }
                                    break;
                                }
